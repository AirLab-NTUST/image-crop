...
if __name__ =="__main__":
    ...
    parser.add_argument('--path_img', default= "/home/airlab/Desktop/IMAGE_CROP/Single_bud_dataset/train_new", type=str, required=False,
                        help= 'direction of image folder') #path to the folder that contain image


    parser.add_argument('--path_an', default= "/home/airlab/Desktop/IMAGE_CROP/Single_bud_dataset/an_train_new", type=str, required=False,
    ...
    for index_1,image_name in enumerate(filenames):
        ...
        cv2.imshow("mask_image", resized_img(concate_img,30))
        k = cv2.waitKey(0)
