...
if __name__ == "__main__":
    '''
    python convert_json_labelme2mask_with_angle.py 
    '''
    parser = argparse.ArgumentParser(description='Process some integers.')
    parser.add_argument('--path_json', default= "/home/airlab/Desktop/IMAGE_CROP/Single_bud_dataset/datas3_singlebud/datas3", type=str, required=False,
